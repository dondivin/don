    ...
    <main>
        ...
        if(mysqli_num_rows($res1)>0){
         ...
         ?>
             <div class="info">
                <h1>POST :</h1>
                <input type="text" value="Gouveneur de la Province" readonly>
               </div>
               <div class="info">
                <h1>Province :</h1>
        ...
        <div class="doc">
            ...
            <div class="mydoc">
            <?php
              $req2 = "SELECT * FROM document WHERE validetor = '$validator' AND status_doc !='Rejeté' AND province = '$province'";
              $res_req = mysqli_query($conn, $req2);
        if(mysqli_num_rows($res_req)>0){
         ...
         <div class="allDocs">
                ...
                <?php 
                    ...
                    <h2>Résidant actuelle : <?=$row1['Residence_actu_zone']?>,Commune <?=$row1['Residence_actu_com']?> Province <?=$row1['Residence_actu_prov']?> </h2>

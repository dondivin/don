    ...
    <main>
        ...
        if(mysqli_num_rows($res1)>0){
         ...
         ?>
                      <div class="info">
                <h1>POST :</h1>
                <input type="text" value="Procureur Général" readonly>
               </div>
               <div class="info">
                <h1>Province :</h1>
        ...
        <div class="doc">
            ...
            <div class="mydoc">
            <?php
             $req2 = "SELECT * FROM document WHERE validetor = 'PG' OR validetor = 'CGPJ' AND status_doc !='Rejeté'";
